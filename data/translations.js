// Bilingual Translations Catalog for Kura Sushi Taiwan Case Study & Lab
export const translations = {
  zh: {
    ...
    "hero.subtitle": "台灣藏壽司（Kura Sushi Taiwan）商業策略個案分析與高互動體驗開發實驗室",
    ...
    "dash.external.desc": "PESTEL 與波特五力產業分析",
...
// Strategic Analysis Written Contents
export const caseContent = {
  zh: {
    ...
    pestel: [
      {
        id: "p",
        title: "政治環境 (Political)",
        desc: "台灣對於跨國外商投資（投審會）法規透明，保障智財權與外國專利（如藏壽司保鮮蓋專利、餐盤輸送回收道專利）。然而，日圓與新台幣之間的匯率波動及台日貿易協定，直接影響日本進口食材（如海膽、黑鮪魚）的採購成本。"
      },
      {
        id: "e",
        title: "經濟環境 (Economic)",
        desc: "台灣近年來基本工資連續調升，餐飲服務業面臨嚴重的勞動成本通膨。此外，後疫情時代台灣消費力復甦，但伴隨而來的民生通膨與外送平台（Foodpanda, UberEats）的普及，也改變了消費者的內用頻率與單次客單價分配。"
      },
      {
        id: "s",
        title: "社會環境 (Social)",
        desc: "台灣人口結構呈現極速「老齡化」與「少子化」趨勢，家庭結構走向核心小家庭與單身化。這使得傳統大份量桌菜退流行，個人化、快速精緻的平價壽司成為首選。同時，台灣消費者具有強烈的「IP 聯名敏感度」，極易受限量動漫周邊吸引，產生衝動型消費。"
      },
      {
        id: "t",
        title: "技術環境 (Technological)",
        desc: "智慧型行動支付普及與數位會員 App 推廣成為基本配置。藏壽司引進日本研發的 AI 影像監控系統（安裝於迴轉軌道上方，判讀取盤行為並防範食品安全事件）、自動化軌道除盤與平板系統。科技化的高度導入，在缺工潮中成為抵禦危機的關鍵武器。"
      },
      {
        id: "env",
        title: "環境保護 (Environmental)",
        desc: "全球永續發展 ESG 與減塑政策推動。台灣自 2024 年起推動綠色餐飲指引，限制一次性餐具。藏壽司積極開發可回收餐具、智慧排程點餐以減少每日食材廚餘損耗，同時導入節能洗碗專利系統，以符合碳中和與節水之合規要求。"
      },
      {
        id: "l",
        title: "法律規範 (Legal)",
        desc: "台灣食品安全衛生管理法極其嚴格，尤其是對進口生鮮水產品的重金屬、寄生蟲與殘留物檢驗。藏壽司導入之專利「鮮度君」保鮮蓋，在法規上符合食品衛生防塵防沫之高度要求，有助於降低因食安事件引發的訴訟風險與商譽損害。"
      }
    ],
    porter: {
      entrants: {
        score: 4,
        title: "新進入者威脅 (高 - 4/5)",
        desc: "台灣餐飲業進入門檻相對低，近年除了日系連鎖（如壽司郎、美登利）持續搶灘，大量本土精品台式或日式個體壽司屋也藉由社群媒體爆紅。然而，要達到藏壽司的全自動化科技規模，初期資本資出（CapEx）極高，部分減緩了巨型新進者的直接威脅。"
      },
      buyers: {
        score: 3.5,
        title: "購買者協商力量 (中偏高 - 3.5/5)",
        desc: "消費者轉置成本（Switching Costs）幾乎為零，在多品牌（壽司郎、爭鮮、點爭鮮）環伺下，顧客忠誠度極易隨優惠活動或季節菜單而波動。藏壽司透過極高頻率的 IP 聯名（如吉伊卡哇扭蛋）作為護城河，成功將顧客協商力量降低，鎖定核心家庭與年輕客群。"
      },
      suppliers: {
        score: 2.5,
        title: "供應商協商力量 (偏低 - 2.5/5)",
        desc: "藏壽司母公司擁有全球性的食材採購網絡（母公司在日本直接與世界各漁場進行大規模期貨契作），在採購鮭魚、鮪魚等核心魚種時具備強大議價優勢。但在台灣在地鮮食（如米、蔥、蔬菜）及即時配送物流方面，受制於在地冷鏈物流商的定價影響。"
      },
      substitutes: {
        score: 4.5,
        title: "替代品威脅 (極高 - 4.5/5)",
        desc: "平價餐飲選擇種類極多，如拉麵、燒肉、定食及外送便當，皆為壽司的替代品。尤其壽司多屬冷食，冬天或下雨天替代品（如火鍋、暖湯）之吸客效應非常明顯。藏壽司透過熱食炸物（如炸蝦天婦羅、拉麵）及高人氣甜點（牛奶冰淇淋鯛魚燒）進行品類橫向擴展，以抵抗替代威脅。"
      },
      rivalry: {
        score: 4.8,
        title: "產業內部競爭激烈度 (極高 - 4.8/5)",
        desc: "迴轉壽司產業在台灣已進入紅海撕殺。爭鮮以全台百家店鋪占據絕對地理優勢；日本龍頭「壽司郎」以食材品質（尤其是鮮美紅肉魚）著稱，是藏壽司最直接的勁敵。兩者在店面選址、新品推出頻率、會員App功能及聯名檔期上展開全面近身戰。"
      }
    },
    vrio: [
      {
        resource: "專利「鮮度君」半自動防護蓋",
        v: "✓ Yes (保護食材免受飛沫與病毒污染，降低報廢率)",
        r: "✓ Yes (全球獨家設計與專利保護，對手無法抄襲其防護卡榫)",
        i: "✓ Yes (機械卡榫研發與國際專利壁壘高，仿造面臨侵權訴訟)",
        o: "✓ Yes (廚房作業流程全面圍繞該設備設計，落實SOP運營)",
        implication: "持續性競爭優勢 (Sustainable Competitive Advantage)",
        details: "「鮮度君」不僅是一片透明防護罩，它內含紅外線偵測器，盤子一經掀開即自動回報後台 POS 系統記錄消耗，完美融合食安與數據管理。"
      },
      {
        resource: "Bikkura Pon 扭蛋互動娛樂行銷系統",
        v: "✓ Yes (大幅提升就餐趣味度與客單價，產生主動清盤動機)",
        r: "✓ Yes (同業僅能模仿回收盤，無法重現完整的數位聯名與扭蛋掉落生態)",
        i: "✓ Yes (高昂的IP聯名授權談判能力，以及軟硬體系統整合難度)",
        o: "✓ Yes (與後台回收系統、廚房自動化產線及結帳系統高度協同)",
        implication: "持續性競爭優勢 (Sustainable Competitive Advantage)",
        details: "扭蛋機背後是精心設計的機率算法與聯名 IP 的吸客效應。消費者為了「集滿五盤」抽獎，往往會超量消費 1-2 盤，是行銷學上『遊戲化（Gamification）』的教科書級應用。"
      },
      {
        resource: "智慧除盤水流輸送與自動洗碗系統",
        v: "✓ Yes (極大化減少外場收盤人力，縮短翻桌時間並提升廚房清潔效率)",
        r: "✓ Yes (獨家專流水槽管道設計與洗滌烘乾一體化專利設備)",
        i: "✓ Yes (店鋪土木管線設計與專利機械製造工藝極難完美複製)",
        o: "✓ Yes (前台顧客餐盤回收直接連接後台清洗流水線，完美整合)",
        implication: "持續性競爭優勢 (Sustainable Competitive Advantage)",
        details: "顧客吃完將盤子投入桌邊的「回收口」，盤子會順著桌下水道利用水流自動漂送回廚房中央洗碗機。這項技術使藏壽司的外場人員配比相較傳統壽司店減少了 35% 以上，大幅減輕缺工壓力。"
      },
      {
        resource: "全球採購冷鏈與合約物料網絡",
        v: "✓ Yes (穩定取得高CP值之進口生鮮鮭魚、鮪魚)",
        r: "✗ No (壽司郎及其他國際連鎖也具備跨國冷鏈與大型期貨合約採購能力)",
        i: "— Moderate (建立全球供應商網絡需時數年，資金要求大但非不可能)",
        o: "✓ Yes (由日本母公司統一調度全球大宗採購以發揮規模經濟效益)",
        implication: "競爭均勢 (Competitive Parity)",
        details: "雖然採購網絡不是獨一無二的，但它是進入這個行業的「基礎入場券」，確保在原料成本大漲時仍能維持單盤40元台幣的價格彈性。"
      }
    ],
    chain: `
    ...
    challenges: `
      <div class="challenge-item">
        ...
        <p class="challenge-desc">少子化與年輕世代職業觀念改變（傾向外送員或彈性接案），使得餐飲業面臨大缺工。雖然藏壽司有高度自動化水流與平板，但仍需內場備料與基本外場清潔引導。基本工資逐年調升（預估未來面臨時薪220元台幣大關），嚴重壓縮營業利潤率。</p>
      </div>
      <div class="challenge-item">
      ...
      <div class="challenge-item">
        ...
        <p class="challenge-desc">直接對手「壽司郎（Sushiro）」在食材的高級感與季節鮮魚鮮度上口碑極佳，且近期也大幅跟進 App 優化與熱門 IP 聯名。爭鮮則推出「點爭鮮」與精品副品牌「爭鮮gogo」展開價格戰與包圍網。藏壽司若僅依靠扭蛋新鮮感，當消費者對扭蛋玩法產生視覺疲勞時，可能面臨客群向高品質或更低價格對手流失的風險。</p>
      </div>
    `,
    conclusion: `
      <p class="case-text">綜上所述，<b>台灣藏壽司</b>的成功絕非偶然，而是將<b>「自動化工業工程 (IE)」與「體驗娛樂行銷 (Experiential Marketing)」</b>完美融為一體的經典商業策略展現。其引以為傲的專利防護蓋『鮮度君』、桌下水流收盤管道及 Bikkura Pon 扭蛋機，成功構築了 VRIO 矩陣中的『持續性競爭優勢』，在抵禦台灣嚴峻缺工與食材通膨浪潮中，發揮了中流砥柱的作用。</p>
  ...
  en: {
    ...
    pestel: [
      ...
      },
      {
        id: "l",
        title: "Legal Forces",
        desc: "Taiwan enforces extremely stringent Food Safety and Sanitation standards, particularly regarding heavy metals, parasites, and chemical residues in raw seafood. Kura Sushi's patented 'Mr. Fresh' dome covers strictly comply with sanitation laws, protecting food from airborne dust and customer droplets, which significantly decreases litigation and brand equity risks."
      }
    ],
    porter: {
      entrants: {
        score: 4,
        title: "Threat of New Entrants (High - 4/5)",
        desc: "The barrier to entry for small-scale dining in Taiwan is low, and numerous local gourmet sushi bars gain viral traction via Instagram. However, scaling to Kura Sushi's level of automated tech integration requires substantial capital expenditure (CapEx), protecting Kura from immediate high-volume entry threats."
      },
      buyers: {
        score: 3.5,
        title: "Bargaining Power of Buyers (Moderate-High - 3.5/5)",
        desc: "Customer switching costs are near zero. With multi-brand competition (Sushiro, Sushi Express), customer loyalty easily fluctuates based on menu updates or campaigns. Kura Sushi builds a powerful defense using high-frequency IP collaborations (e.g., Chiikawa capsule toys), capturing core family and Gen-Z groups and mitigating buyer power."
      },
      suppliers: {
        score: 2.5,
        title: "Bargaining Power of Suppliers (Low-Moderate - 2.5/5)",
        desc: "Kura Sushi's parent corporation manages a massive centralized international procurement network, locking in long-term futures contracts directly with global fisheries. This grants Kura extreme wholesale bargaining power for salmon and tuna. However, local fresh ingredients (rice, vegetables) remain vulnerable to local logistics pricing."
      },
      substitutes: {
        score: 4.5,
        title: "Threat of Substitutes (Very High - 4.5/5)",
        desc: "A vast array of casual dining options exist, including ramen, yakiniku, and bento delivery. Because sushi is primarily served cold, the threat of hot food substitutes (hotpot, warm soups) skyrockets during winters. Kura Sushi hedges this risk by offering hot dishes (ramen, tempura) and highly popular desserts (matcha ice cream and taiyaki) to extend customer appeal."
      },
      rivalry: {
        score: 4.8,
        title: "Industry Rivalry (Extreme - 4.8/5)",
        desc: "The conveyor belt sushi industry in Taiwan is a brutal red ocean. Sushi Express boasts hundreds of branches, dominating geographical convenience. Japan's top brand, 'Sushiro', is renowned for its superior raw fish quality and is Kura's fiercest rival. The two clash directly in premium locations, app features, and licensing schedules."
      }
    },
    vrio: [
      {
        resource: "Patented 'Mr. Fresh' (鮮度君) Protective Dome",
        v: "✓ Yes (Shields sushi from airborne droplets, preserves freshness, reduces disposal rates)",
        r: "✓ Yes (Proprietary international patents prevent direct copying of its mechanical hinge)",
        i: "✓ Yes (High engineering and worldwide patent barriers; duplication triggers patent lawsuits)",
        o: "✓ Yes (Entire kitchen layout and food safety SOP are designed around this system)",
        implication: "Sustainable Competitive Advantage",
        details: "'Mr. Fresh' is not just a plastic cover. It contains infrared sensors that report dish liftoffs directly to the back-end POS, merging safety with real-time data tracking."
      },
      {
        resource: "Bikkura Pon (びっくらポン) Gamified Toy System",
        v: "✓ Yes (Dramatically boosts dining fun, triggers clear-plate actions, increases check size)",
        r: "✓ Yes (Competitors can collect plates but cannot replicate the interactive animation/capsule cycle)",
        i: "✓ Yes (Requires high-level IP negotiation capability and seamless software-hardware integration)",
        o: "✓ Yes (Perfect alignment with the disposal chutes, POS billing, and real-time kitchen logistics)",
        implication: "Sustainable Competitive Advantage",
        details: "Supported by precise algorithm odds and high-demand character licensing. Customers often eat 1-2 extra plates just to hit the next 5-plate lottery threshold, a textbook case of 'Gamification' in marketing."
      },
      {
        resource: "Patented Under-Table Water Chute & Automated Washers",
        v: "✓ Yes (Reduces floor staff workload, accelerates table turnover, maximizes kitchen efficiency)",
        r: "✓ Yes (Unique under-table waterway pipe layouts combined with patented automated washing technology)",
        i: "✓ Yes (Extremely hard to replicate within existing, non-customized commercial plumbing structures)",
        o: "✓ Yes (Direct connection between the front-end customer disposal slot and back-end washing lines)",
        implication: "Sustainable Competitive Advantage",
        details: "Empty plates slide down the table slot and float back to the kitchen washers. This reduces front-of-house staff count by over 35% compared to traditional sushi bars, acting as a buffer against labor shortages."
      },
      {
        resource: "Global Cold-Chain Supply & Sourcing Network",
        v: "✓ Yes (Ensures stable, cost-efficient import of fresh salmon and tuna)",
        r: "✗ No (Sushiro and other global chains possess similar global cold-chain purchasing capabilities)",
        i: "— Moderate (Takes years to set up global supply agreements, requiring vast funds but possible)",
        o: "✓ Yes (Leveraged through parent company bulk imports to maximize economies of scale)",
        implication: "Competitive Parity",
        details: "While not unique, this global scale is an absolute 'entry ticket' to keep plates priced at an affordable NT$40 base despite global seafood cost inflation."
      }
    ],
    chain: `
      <div class="chain-step">
